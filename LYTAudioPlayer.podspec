#
#  Be sure to run `pod spec lint iOSAudioQueuePlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/dfg-nota/iOS-LYTAudioPlayer"
  ...
  s.source       = { :git => "https://github.com/dfg-nota/iOS-LYTAudioPlayer.git", :tag => "#{s.version}" }
  ...
  s.exclude_files = "LYTAudioPlayerDemo"
